  ...
  return (
    <div className={cn("grid gap-2", className)}>
      <Popover>
        ...
        <PopoverContent className={`w-auto p-0 flex ${theme === 'light' ? "bg-white text-black": "bg-black text-white"} `} align='start'>
          <Select
            onValueChange={(value) =>
          ...
          <div className={`${theme === "light" ? 'border-t border-border':'bg-black text-white border-0'}`}>
            <Calendar
              initialFocus
              mode='range'
